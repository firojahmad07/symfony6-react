...
const ProductDataBreadCrumbs: Array<PageLink> = [
    {
        title: 'Products',
        path: '/catalog/product/45',
        isSeparator: false,
        isActive: false,
    },
]
                                    ...
                                    <div className="card card-flush py-4">
                                        ...
                                        <div className="card-body pt-0">
                                            ...
                                            <div>
                                                ...
                                                <div id="kt_ecommerce_add_product_description" data-name="kt_ecommerce_add_product_description" className="min-h-200px mb-2"></div>
                                                ...
                                                <div className="row row-cols-1 row-cols-md-3 row-cols-lg-1 row-cols-xl-3 g-9" data-kt-buttons="true" data-kt-buttons-target="[data-kt-button='true']">
                                                    ...
                                                    <div className="col">
                                                        ...
                                                        <label className="btn btn-outline btn-outline-dashed btn-active-light-primary active d-flex text-start p-6" data-kt-button="true">
                                                            ...
                                                            <span className="form-check form-check-custom form-check-solid form-check-sm align-items-start mt-1">
                                                                <input className="form-check-input" type="radio" name="discount_option" value="2" checked={true} />
                                                            </span>
                                            ...
                                            <div className="d-flex flex-wrap gap-5">
                                                ...
                                                <div className="fv-row w-100 flex-md-root">
                                                    ...
                                                    <select className="form-select mb-2" name="tax" data-control="select2" data-hide-search="true" data-placeholder="Select an option">
                                                        ...
                                                        <option value="1" selected={true}>Taxable Goods</option>
                                    ...
                                    <div className="card card-flush py-4">
                                        ...
                                        <div className="card-body pt-0">
                                            ...
                                            <div className="fv-row">
                                                ...
                                                <div className="form-check form-check-custom form-check-solid mb-2">
                                                    <input className="form-check-input" type="checkbox" id="kt_ecommerce_add_product_shipping_checkbox" value="1" checked={true} />
                                    ...
                                    <div className="card card-flush py-4">
                                        ...
                                        <div className="card-body pt-0">
                                            ...
                                            <div className="mb-10">
                                                ...
                                                <div id="kt_ecommerce_add_product_meta_description" data-name="kt_ecommerce_add_product_meta_description" className="min-h-100px mb-2"></div>
...
const EditProduct = () => {
    ...
    return (
        <>
            <PageTitle breadcrumbs={ProductDataBreadCrumbs}>
                {intl.formatMessage({ id: 'menu.edit_product' })}
            </PageTitle>
            <ProductData />
        </>
    )
